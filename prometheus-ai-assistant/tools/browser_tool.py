...
def _run_chrome_fallback_command(
    ...
    def _run_tmp(cmd: str, cmd_args: List[str]) -> Dict[str, Any]:
        ...
        try:
            ...
            #   in the Прометей CLI where sys.stdout and sys.stderr both report
...
def _find_agent_browser() -> str:
    ...
    Checks in order: current PATH, Homebrew/common bin dirs, Прометей-managed
    ...
    # Build an extended search PATH including Прометей-managed Node, macOS
