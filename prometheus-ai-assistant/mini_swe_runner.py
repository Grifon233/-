...
A runner that uses Прометей-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Прометей-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Прометей-Agent's Docker, Modal, or Local environments for command execution
...
# ============================================================================
# Terminal Tool Definition (matches Прометей-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Прометей-Agent's built-in backends.
...
class MiniSWERunner:
    """
    Agent runner that uses Прометей-Agent's built-in execution environments
    and outputs trajectories in Прометей-Agent format.
    """
