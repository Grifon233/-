#!/usr/bin/env python3
"""
Skills Hub CLI — Unified interface for the Прометей Skills Hub.
...
def do_install(identifier: str, category: str = "", force: bool = False,
    ...
    c.print(build_install_preview(result))
    ...
    if not force and not skip_confirm:
        ...
        if bundle.source == "official":
            c.print(Panel(
                "[bold bright_cyan]This is an official optional skill maintained by Прометей.[/]\n\n"
    ...
    try:
        resp = httpx.post(
            ...
            json={
                ...
                "body": f"Submitting the `{skill_name}` skill via Прометей Skills Hub.\n\n"
                        f"This skill was scanned by the Прометей Skills Guard before submission.",
