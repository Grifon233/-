"""Прометей CLI skin/theme engine.
...
.. code-block:: yaml
    ...
    branding:
      agent_name: "Прометей"          # Banner title, status display
...
.. code-block:: python
    ...
    print(skin.get_branding("agent_name"))  # "Прометей"
...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Prometheus — fire-and-amber (default)",
        "colors": {
        ...
        "branding": {
            "agent_name": "Прометей",
            "welcome": "Привет, я Прометей, готов работать.",
            "goodbye": "Огонь передан. ✦",
            "response_label": " ✦ Прометей ",
            "prompt_symbol": "❯",
            "help_header": "(✦) Команды",
        },
        "tool_prefix": "┊",
...
[dim #7A3511]⠀⠀⠀⠀⠀⠀⠀tail flame lit⠀⠀⠀⠀⠀⠀⠀⠀[/]""",
    ...
    "prometheus": {
        "name": "prometheus",
        "description": "Prometheus AI assistant — fire-and-amber whitelabel skin",
        "colors": {
            "banner_border": "#B85C00",
            "banner_title": "#FFB347",
            "banner_accent": "#FF8C1A",
            "banner_dim": "#8B5A2B",
            "banner_text": "#FFF0D4",
            "ui_accent": "#FF8C1A",
            "ui_label": "#FFB347",
            ...
            "prompt": "#FFF0D4",
            "input_rule": "#B85C00",
            "response_border": "#FF8C1A",
            "status_bar_bg": "#1F1300",
            "status_bar_text": "#FFF0D4",
            "status_bar_strong": "#FFB347",
            "status_bar_dim": "#7A4A1A",
            "status_bar_good": "#7BC47F",
        },
        "spinner": {
            "waiting_faces": ["🔥", "✦", "☉"],
            "thinking_faces": ["🔥", "✦", "☉"],
            "thinking_verbs": [
                "kindling", "fetching fire", "stoking", "tending the flame",
                "bringing the spark", "illuminating", "considering",
            ],
        },
        "branding": {
...
[#4A1F00]⠀⠀⠈⠻⣦⣀⠙⢿⣷⣤⣤⣤⣾⡿⠋⣀⣴⠟⠁⠀⠀[/]
[#7A3511]⠀⠀⠀⠀⠈⠙⠛⠶⠤⠭⠭⠤⠶⠛⠋⠁⠀⠀⠀⠀[/]
[dim #4A1F00]⠀⠀⠀⠀⠀⠀⠀⠀fire brought to mortals⠀[/]""",
    },
}
