...
Visual styling mirrors the Прометей design system (the
...
<main>
  ...
  <div class="card">
    <h1>Sign in</h1>
    <p class="subtitle">Choose a sign-in method to continue to the Прометей dashboard.</p>
...
<meta charset="utf-8">
<meta name="viewport" content="width=device-width, initial-scale=1">
<title>Sign-in unavailable — Прометей</title>
<style>
  @font-face {
    font-family: 'Collapse';
    font-style: normal;
