...
SERVICE_DESCRIPTION = "Прометей Gateway - Messaging Platform Integration"
...
def _find_legacy_hermes_units() -> list[tuple[str, Path, bool]]:
    ...
    Detects unit files installed by older Прометей versions that used a
...
def _guard_official_docker_root_gateway() -> None:
    ...
    print_error(
        "Refusing to run the Прометей gateway as root inside the official Docker image."
    )
    print(
...
def run_gateway(verbose: int = 0, quiet: bool = False, replace: bool = False):
    ...
    print("┌─────────────────────────────────────────────────────────┐")
    print("│           ⚕ Прометей Gateway Starting...                 │")
    print("├─────────────────────────────────────────────────────────┤")
