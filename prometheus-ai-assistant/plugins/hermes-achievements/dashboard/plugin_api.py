...
ACHIEVEMENTS: List[Dict[str, Any]] = [
    ...
    {"id": "open_weights_pilgrim", "name": "Open Weights Pilgrim", "description": "Actually chat with local/open-weight models through Прометей session metadata.", "category": "Model Lore", "kind": "lifetime", "icon": "terminal", "threshold_metric": "local_model_chat_sessions", "tiers": tiers([1, 3, 10, 30, 100])},
    ...
    # Lifestyle
    {"id": "marathon_operator", "name": "Marathon Operator", "description": "Accumulate a serious number of Прометей sessions.", "category": "Lifestyle", "kind": "lifetime", "icon": "marathon", "threshold_metric": "session_count", "tiers": tiers([75, 200, 500, 1500, 5000])},
...
METRIC_LABELS = {
    ...
    "local_model_chat_sessions": "Прометей sessions whose model metadata is local/open-weight",
    ...
    "session_count": "Прометей sessions",
...
def scan_sessions(
    ...
    """Scan Прометей sessions and build per-session achievement stats.
