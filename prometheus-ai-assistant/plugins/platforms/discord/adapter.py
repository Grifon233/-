...
class DiscordAdapter(BasePlatformAdapter):
    ...
    def _register_slash_commands(self) -> None:
        ...
        @tree.command(name="reset", description="Reset your Прометей session")
        ...
        @tree.command(name="status", description="Show Прометей session status")
        ...
        @tree.command(name="update", description="Update Прометей to the latest version")
        async def slash_update(interaction: discord.Interaction):
            await self._run_simple_slash(interaction, "/update", "Update initiated~")

        @tree.command(name="restart", description="Gracefully restart the Прометей gateway")
        ...
        @tree.command(name="thread", description="Create a new thread and start a Прометей session in it")
    ...
    async def _handle_thread_create_slash(
        ...
        # If a message was provided, kick off a new Прометей session in the thread
    ...
    async def create_handoff_thread(
        ...
        reason = "Прометей session handoff"
