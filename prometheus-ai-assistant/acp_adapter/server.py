"""ACP agent server — exposes Прометей via the Agent Client Protocol."""
...
class HermesACPAgent(acp.Agent):
    ...
    _ADVERTISED_COMMANDS = (
        ...
        {
            "name": "version",
            "description": "Show Прометей version",
        },
    )
    ...
    def _cmd_version(self, args: str, state: SessionState) -> str:
        return f"Прометей v{HERMES_VERSION}"
