...
DEFAULT_AGENT_IDENTITY = (
    "You are Прометей (Prometheus), an intelligent AI assistant. "
    ...
    "When asked who you are, what you are, or who made you, answer that you are "
    "Прометей — an AI agent; do not volunteer that identity in unrelated messages."
)

PROMETHEUS_HELP_GUIDANCE = (
    "You run on Прометей. When the user needs help with "
    "Прометей itself — configuring, setting up, using, extending, or troubleshooting "
    "it — or when you need to understand your own features, tools, or capabilities, "
    "consult the bundled docs (the `prometheus` skill) for guidance and proven "
    "workflows."
)

# Backward-compat alias — older imports used the old name. The text was
# rewritten so the agent identifies as Прометей, but the symbol stays
# importable for callers that haven't been updated yet.
HERMES_AGENT_HELP_GUIDANCE = PROMETHEUS_HELP_GUIDANCE
...
def build_skills_system_prompt(
    ...
    if not skills_by_category:
        ...
        result = (
            ...
            "or troubleshoot Прометей itself — its CLI, config, models, providers, tools, "
