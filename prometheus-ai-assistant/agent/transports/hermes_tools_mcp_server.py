"""Прометей-tools-as-MCP server for the codex_app_server runtime.
...
def _build_server() -> Any:
    ...
    mcp = FastMCP(
        "hermes-tools",
        instructions=(
            "Прометей's tool surface, exposed for use inside a Codex "
...
def main(argv: Optional[list[str]] = None) -> int:
    ...
    # Quiet mode: keep Прометей's own banners off stdout (which is the MCP wire).
