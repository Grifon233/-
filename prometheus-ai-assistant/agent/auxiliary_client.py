...
def _codex_cloudflare_headers(access_token: str) -> Dict[str, str]:
    ...
    """
    headers = {
        # HTTP header values must remain ASCII-compatible. A Cyrillic product
        # name raises UnicodeEncodeError in httpx and triggers the agent's
        # last-resort non-ASCII payload scrubber, which deletes Russian input.
        "User-Agent": "codex_cli_rs/0.0.0 (Prometey)",
