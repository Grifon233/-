...
def run_conversation(
    ...
    # are reused.  The system prompt is Прометей's territory; plugins
        ...
        while retry_count < max_retries:
            ...
            try:
                ...
                if (
                    ...
                    from hermes_constants import display_hermes_home as _dhh_fn
                    _dhh = _dhh_fn()
                    print(f"{agent.log_prefix}     • Check ANTHROPIC_TOKEN in {_dhh}/.env for Прометей-managed OAuth/setup tokens")
